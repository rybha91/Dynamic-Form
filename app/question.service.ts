...
import { RadioQuestion } from 'app/question-radio';
import { CheckboxQuestion } from 'app/question-checkbox';
import { LabelQuestion } from 'app/question-label';
import { TextareaQuestion } from 'app/question-textarea';

@Injectable()
export class QuestionService {

  getPersonalandFamilyHistoryQuestions() {
  ...
  getQuestions() {
    ...
    this.questions2.rows.sort((a: any, b: any) => {
      return a.rowProperties.rowDisplayOrder - b.rowProperties.rowDisplayOrder;
    });
    this.questions2.rows.forEach((element: any) => {
